	...
	_createClass(MineSweeping, [{
		...
		value: function render() {
			...
			return React.createElement(
				...
				React.createElement(Text, { x: width / 2, y: height / 2, text: 'Game Over', attr: { "fill": "red", "font-size": 32 }, hide: !gameOver }),
				React.createElement(Text, { x: width / 2, y: height / 2, text: 'Game Win', attr: { "fill": "green", "font-size": 32 }, hide: !gameWin })
			);
		}
	}]);
